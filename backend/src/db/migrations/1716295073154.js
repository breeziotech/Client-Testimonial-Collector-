module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('testimonials', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('testimonials', 'email', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('testimonials', 'testimonial_text', {
        transaction,
      });

      await queryInterface.removeColumn('testimonials', 'client_name', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('analytics', 'rejected_count', {
        transaction,
      });

      await queryInterface.removeColumn('analytics', 'approved_count', {
        transaction,
      });

      await queryInterface.removeColumn('analytics', 'submitted_count', {
        transaction,
      });
