...
import { loadColumns } from './configureTestimonialsCols';
...
const TableSampleTestimonials = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (testimonialsNotify.showNotification) {
      notify(
        testimonialsNotify.typeNotification,
        testimonialsNotify.textNotification,
      );
    }
  }, [testimonialsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/testimonials/testimonials-view/?id=${id}`);
  };
...
export default TableSampleTestimonials;
