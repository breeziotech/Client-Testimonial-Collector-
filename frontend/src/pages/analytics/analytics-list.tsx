...
const AnalyticsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'SubmittedCount', title: 'submitted_count', number: 'true' },
    { label: 'ApprovedCount', title: 'approved_count', number: 'true' },
    { label: 'RejectedCount', title: 'rejected_count', number: 'true' },
